...
public class Room
{
    ...
    */
    ...
    public Room(/*int theHeight, int theWidth,*/ bool theLeftWall, bool theRightWall, bool theUpWall, bool theDownWall)
    {
    ...
    public Room(int size) : this(/*size, size,*/ true, true, true, true) 
    {
